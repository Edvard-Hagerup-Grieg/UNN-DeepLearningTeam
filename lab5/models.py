...
def load_mobilenet_model(input_size=(32, 32, 3), number_of_classes=10, weights=None, trainable=True):
...
if __name__ == "__main__":
    model = load_mobilenet_model(weights='imagenet', trainable=False)
    model.summary()