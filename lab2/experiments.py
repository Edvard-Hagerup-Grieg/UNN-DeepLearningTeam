from lab2.models import generate_model_zoo
...
def train_models(models, x, y):
    ...
    for i, model in enumerate(models):
        ...
        history = model.fit(x, y, batch_size=2000, validation_data=(x_val, y_val), epochs=50, callbacks=[earlyStopping, mcp_save], verbose = 2)
